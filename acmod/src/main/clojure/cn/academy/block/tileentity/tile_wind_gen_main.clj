...
(gen-class
  :name cn.academy.block.tileentity.TileWindGenMain$Factory
  :methods [^:static [create [] Object]]
  :prefix "tile-factory-")

(defn tile-factory-create []
  (create-wind-gen-tile))
(ns cn.academy.tech-system.energy-system.network.energy-sync
...
(defn create-energy-sync-packet [pos energy-stored]
  (->EnergySyncPacket pos energy-stored))

(defn register-packet! [channel]
  (channel/register-message! channel "energy_sync" ->EnergySyncPacket))
(ns cn.academy.forge-1-16.init
  (:require [cn.academy.core.init :as core-init]
            [cn.academy.core.registry :as core-registry]
            [cn.academy.api.render :as render-api]
            [cn.academy.forge-1-16.block :as forge-block]
            [cn.academy.forge-1-16.energy :as forge-energy]
            [cn.academy.forge-1-16.render :as forge-render]
            [cn.academy.forge-1-16.registry :as forge-registry])
...
(gen-class
  :name cn.academy.forge_1_16.Init
  :prefix "init-"
...
(OnlyIn Dist/CLIENT)
(defn init-clientSetup [_ ^FMLClientSetupEvent event]

(ns cn.academy.block.node-block-1-16
...
;; Block state properties for 1.16.5
(def connected-prop (BooleanProperty/create "connected"))
(def energy-prop (IntegerProperty/create "energy" 0 4))

(defrecord NodeBlock1_16 [core-block]
  block-api/IForgeBlock1_16
  (createBlockStateDefinition [_ builder]
  ...
  (createTileEntity [_ state world]
    (core/create-tile-entity core-block world 0)))

(defn create-node-block [type]
  (->NodeBlock1_16 (core/create-node-block type)))
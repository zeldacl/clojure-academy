...
(deftype BlockRegistration116 []
  reg/IBlockRegistration
  (register-block! [_ block-def mod-id block-id]
    (let [block (reg/create-block (BlockFactory116.) 

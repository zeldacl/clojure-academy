(ns cn.academy.forge.v1-16-5.block.node
...
;; Block container implementation for 1.16.5
(defrecord NodeBlockContainer [^Block block]
  ...
  (set-harvest-level! [_ tool level]
    (.. block properties (harvestTool (net.minecraftforge.common.ToolType/get tool)) 
        (harvestLevel level)))
...
;; Factory implementation for 1.16.5
(defrecord NodeBlockFactory []
  ...
  (get-block-material [_ type]
    (case type
      "rock" Material/STONE ; Changed from ROCK to STONE in 1.16
